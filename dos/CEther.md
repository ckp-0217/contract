...
```solidity
function liquidateBorrow(address borrower, contract CToken cTokenCollateral) external payable
```
...
| cTokenCollateral | contract CToken | The market in which to seize collateral from the borrower |
